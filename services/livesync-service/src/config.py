"""
Configuration settings for the LiveSync Service.
...
- LiveSync-specific rate limits aligned with shared-constants/livesync.ts
...
class Settings(BaseSettings):
    ...
    # ==========================================================================
    SERVICE_NAME: str = Field(default="livesync-service", alias="SERVICE_NAME")
