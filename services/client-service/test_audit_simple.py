...
async def test_audit_logging():
    ...
    try:
        ...
        print(f"   ✅ Found {len(entity_logs)} audit entries for client\n")
        ...
        print(f"   ✅ 'create' audit log created")
        ...
        print(f"   ✅ Total audit logs in workspace: {count_result['total']}\n")
