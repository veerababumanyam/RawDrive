...
WITH plan_updates AS (
    ...
    FROM (VALUES
        (
            'free',
            'Starter',
            'Free forever for beginners trying galleries before a paid event.',
            0::BIGINT,
            0::BIGINT,
            5368709120::BIGINT,
            1::INTEGER,
        ...
        (
            'creator',
            'Creator',
            'Side and weekend photographers getting started.',
            49900::BIGINT,
            499000::BIGINT,
            107374182400::BIGINT,
            10::INTEGER,
        ...
        (
            'pro_photographer',
            'Pro Photographer',
            'The main money plan for working pros.',
            99900::BIGINT,
            999000::BIGINT,
            322122547200::BIGINT,
            -1::INTEGER,
        ...
        (
            'studio',
            'Studio',
            'Studios with a team and a brand to protect.',
            199900::BIGINT,
            1999000::BIGINT,
        ...
        (
            'elite_studio',
            'Elite Studio',
            'High-end and multi-branch studios with custom limits.',
            399900::BIGINT,
            3999000::BIGINT,
            6597069766656::BIGINT,
            -1::INTEGER,
            -1::INTEGER,
            ARRAY[
                '3TB+ Storage',
...
UPDATE workspace_storage ws
   SET quota_bytes = 6597069766656
  FROM workspaces w
 WHERE ws.workspace_id = w.id
   AND w.plan_tier = 'elite_studio'
   AND ws.quota_bytes = 3298534883328;
