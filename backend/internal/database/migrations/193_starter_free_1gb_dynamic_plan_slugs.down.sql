...
WITH starter_update AS (
    SELECT
        ...
        'Hook beginners with a free starter gallery, then grow them into paid plans.'::TEXT AS description,
        'INR'::TEXT AS currency,
        0::BIGINT AS monthly_price_paise,
        0::BIGINT AS annual_price_paise,
        5368709120::BIGINT AS quota_bytes,
...
UPDATE workspace_storage ws
 ...
 WHERE ws.workspace_id = w.id
   ...
   AND ws.quota_bytes IS DISTINCT FROM 5368709120;
