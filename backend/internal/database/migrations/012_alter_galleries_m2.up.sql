...
-- Rename 'name' to 'title' if it still exists as 'name'
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'galleries' AND column_name = 'name') THEN
