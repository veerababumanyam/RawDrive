...
func TestStillImageFormatFromContentType(t *testing.T) {
	tests := []struct {
		...
		{"image/x-nikon-nrw", "nrw", true},
		{"image/x-sony-arq", "arq", true},
		{"image/x-sony-sr2", "sr2", true},
		{"image/x-gopro-gpr", "gpr", true},
		{"image/x-leica-rwl", "rwl", true},
		{"image/hif", "hif", true},
		{"image/x-pentax-pef", "pef", true},
		{"image/x-sigma-x3f", "x3f", true},
