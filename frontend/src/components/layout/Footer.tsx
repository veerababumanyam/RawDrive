      ...
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <Link
              href="/"
              className="touch-target-link gap-2.5"
            ...
            <ul className="mt-4 space-y-1.5 text-xs text-text-tertiary">
              {contactLinks.map((link) => (
                <li key={link.href} className="flex items-center gap-2">
                  ...
                  <a
                    href={link.href}
                    className="touch-target-link transition-colors hover:text-accent"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <ul className="mt-3 space-y-2">
              {solutionsLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="touch-target-link text-sm text-text-secondary transition-colors hover:text-accent"
          ...
          <div>
            ...
            <h2 className="text-sm font-semibold text-text-primary">Legal</h2>
            <ul className="mt-3 space-y-2">
              {legalLinks.map((link) => (
                <li key={link.href}>
                  <Link
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border-subtle pt-6 text-sm text-text-tertiary sm:flex-row">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="touch-target-link transition-transform hover:scale-105"
            >
              <Image
