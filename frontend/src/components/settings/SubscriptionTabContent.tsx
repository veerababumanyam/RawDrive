/**
 * SubscriptionTabContent Component
 *
 * Subscription settings tab content - plan details, usage, and billing.
 * Mirrors SubscriptionSettingsPage structure for tabbed navigation.
 */
...
export function SubscriptionTabContent({ className }: TabContentProps) {
  ...
  useEffect(() => {
    ...
    if (checkoutStatus === 'success') {
      ...
      refetch();
      // Clear the checkout param but keep the tab param
