/**
 * PrivacyTabContent Component
 *
 * Privacy settings tab content - analytics, profile visibility, and data export.
 * Mirrors PrivacySettingsPage structure for tabbed navigation.
 */
...
export function PrivacyTabContent({ className }: TabContentProps) {
