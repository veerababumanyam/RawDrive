/**
 * SecurityTabContent Component
 *
 * Security settings tab content - password, 2FA, and session management.
 * Mirrors SecuritySettingsPage structure for tabbed navigation.
 */
...
export function SecurityTabContent({ className }: TabContentProps) {
