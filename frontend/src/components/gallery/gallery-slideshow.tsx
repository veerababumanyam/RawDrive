...
export function GallerySlideshow({
  ...
  return (
    ...
    >
      ...
      {musicUrl ? <audio ref={audioRef} src={musicUrl} loop data-testid="slideshow-audio" /> : null}
      ...
      <div className="absolute right-4 top-4">
        <GlassIconButton label="Close slideshow" onClick={onClose} size="md" variant="glass">
          <XMark />
        </GlassIconButton>
      </div>

      <div className="absolute bottom-6 left-1/2 flex -translate-x-1/2 items-center gap-3">
        <GlassIconButton label="Previous slide" onClick={prev} size="md" variant="glass">
          <ChevronLeft />
        </GlassIconButton>
        <GlassIconButton
        ...
        <GlassIconButton label="Next slide" onClick={next} size="md" variant="glass">
          <ChevronRight />
        </GlassIconButton>
        {musicUrl ? (
          <GlassIconButton
