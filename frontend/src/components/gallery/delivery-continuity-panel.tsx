...
export function DeliveryContinuityPanel({
  galleryId,
  token,
  selectedCount,
  totalCount,
}: DeliveryContinuityPanelProps) {
  ...
  return (
    <div
      ...
      data-testid="delivery-continuity-panel"
    >
        ...
        <dl className="grid grid-cols-3 gap-3 text-xs">
          ...
          <div>
            ...
            <dd className="mt-1 text-sm font-medium text-text-primary">
              <span
                className={
                  proofingComplete ? "text-success-primary" : undefined
                }
              >
                {proofingLabel}
              </span>
      ...
      <p className="text-[11px] leading-relaxed text-text-tertiary">
        Downloads, proofing exports, and hand-off status stay attached to this
        gallery workspace. Deliverables live here — no separate module.
      </p>
    </div>
  );
}
