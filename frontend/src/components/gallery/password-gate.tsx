    ...
    <div className="min-h-screen flex items-center justify-center glass-surface">
      <div className="w-full max-w-md p-8 glass-card rounded-2xl shadow-glass">
        ...
        <div className="text-center mb-8">
          ...
          {studioName && (
            <h2 className="text-lg font-medium text-accent">{studioName}</h2>
          )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              className="w-full px-4 py-3 rounded-xl glass-surface border border-glass-border text-accent placeholder:text-tertiary focus:outline-none focus:ring-2 focus:ring-accent"
              autoFocus
