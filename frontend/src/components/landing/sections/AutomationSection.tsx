...
export const AutomationSection: React.FC = () => {
    return (
        <section className="py-20 lg:py-32 relative overflow-hidden bg-neutral-900" id="automation">
            {/* Background Grid */}
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-16 max-w-3xl mx-auto">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-neutral-400 mb-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {FEATURES.map((feature, idx) => (
                        ...
                        >
                            <AppCard
                                variant="sm"
                                className={`h-full border border-white/5 hover:border-white/10 transition-colors bg-gradient-to-br ${feature.gradient}`}
                            >
