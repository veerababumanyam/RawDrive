...
export const typography = {
  ...
  scale: {
    "2xs": { size: "0.75rem", lineHeight: "1.05rem" },
    xs: { size: "0.9rem", lineHeight: "1.2rem" },
    sm: { size: "1.05rem", lineHeight: "1.5rem" },
    base: { size: "1.2rem", lineHeight: "1.8rem" },
    lg: { size: "1.35rem", lineHeight: "2.1rem" },
    xl: { size: "1.5rem", lineHeight: "2.1rem" },
    "2xl": { size: "1.8rem", lineHeight: "2.4rem" },
    "3xl": { size: "2.25rem", lineHeight: "2.7rem" },
    "4xl": {
      size: "clamp(2.7rem, 2.4rem + 1.32vw, 3.3rem)",
      lineHeight: "1.12",
    },
    "5xl": {
      size: "clamp(3.6rem, 3.06rem + 2.4vw, 4.5rem)",
      lineHeight: "1.08",
    },
    "6xl": {
      size: "clamp(4.2rem, 3.36rem + 3.6vw, 5.7rem)",
      lineHeight: "1.05",
    },
    "7xl": {
      size: "clamp(4.8rem, 3.6rem + 5.4vw, 7.2rem)",
      lineHeight: "1.02",
    },
  },
  letterSpacing: {
...
/** Pricing plans fallback; live values are sourced from the backend plan catalog. */
export const pricingPlans = [
  ...
  },
  {
    ...
    features: [
      ...
      "Premium positioning · custom limits",
    ],
  },
] as const;
