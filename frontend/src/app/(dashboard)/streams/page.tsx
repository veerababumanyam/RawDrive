          ...
          {streams.map((stream) => (
            ...
            >
              ...
              <button
                ...
                className="p-2 rounded-lg hover:bg-error/10 text-text-tertiary hover:text-error transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
