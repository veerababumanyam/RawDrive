...
- [ ] 9. Checkpoint - Data Layer Complete
  ...
  - Ensure workspace isolation is enforced
  - Ask the user if questions arise

- [ ] 10. Face Cluster Service
  - [ ] 10.1 Create FaceClusterService
  ...
  - [ ] 10.2 Implement cluster merge operation
  ...
  - [ ] 10.3 Implement cluster split operation
    - Add `splitGroup()` method
    - Create new group with specified faces
    - Update both group centroids
    - _Requirements: 2.8_

  - [ ] 10.4 Write property test for cluster assignment
  ...
  - [ ] 10.5 Write property test for centroid maintenance
...
- [ ] 12. Face Thumbnail Service
  ...
  - [ ] 12.2 Write property test for thumbnail generation
...
- [ ] 14. Background Job Worker
  - [ ] 14.1 Create FaceDetectionWorker
...
- [ ] 15. API Routes and Controllers
  ...
  - [ ] 15.2 Create face group API routes
  ...
  - [ ] 15.3 Create admin AI provider routes
  ...
  - [ ] 15.5 Create FaceGroupController
