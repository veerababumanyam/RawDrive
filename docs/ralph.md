...
**Feature Context**:
*   **Target Feature**: `030-avatar-editor` Avatar Editor
*   **Branch**: `git checkout 030-avatar-editor`
...
*   Read 'specs\030-avatar-editor\tasks.md'
...
*   **Task**: Verify acceptance criteria against `specs/030-avatar-editor/spec.md`.
