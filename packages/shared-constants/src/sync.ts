...
export const SYNC_API_PATHS = {
  ...
  FILE_EVENTS: '/api/v1/sync/file-events',
 ...
 */
export const SYNC_QUOTA_THRESHOLDS = {
...
// ---------------------------------------------------------------------------
// Consolidated Sync Constants Export
// ---------------------------------------------------------------------------
 ...
 */
export const SYNC = {
  RATE_LIMITS: SYNC_RATE_LIMITS,
  TIMING: SYNC_TIMING,
  RETRY: SYNC_RETRY,
  QUEUE_LIMITS: SYNC_QUEUE_LIMITS,
  FILE_LIMITS: SYNC_FILE_LIMITS,
  SESSION_LIMITS: SYNC_SESSION_LIMITS,
  WEBSOCKET: SYNC_WEBSOCKET,
  ERROR_MESSAGES: SYNC_ERROR_MESSAGES,
  FILE_PATTERNS: SYNC_FILE_PATTERNS,
  API_PATHS: SYNC_API_PATHS,
  QUOTA_THRESHOLDS: SYNC_QUOTA_THRESHOLDS,
} as const;
