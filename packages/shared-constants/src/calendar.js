...
export const BOOKING_API_PATHS = {
    ...
    /** ICS file download */
    ICS_DOWNLOAD: (bookingId) => `${API_BASE}/bookings/${bookingId}/ics`,
};
/**
...
export const PUBLIC_BOOKING_PATHS = {
    ...
    PAGE_CONFIG: (workspaceSlug) => `${API_BASE}/public/book/${workspaceSlug}`,
    /** Available dates (public) */
    AVAILABLE_DATES: (workspaceSlug) => `${API_BASE}/public/book/${workspaceSlug}/dates`,
    /** Available slots (public) */
    AVAILABLE_SLOTS: (workspaceSlug) => `${API_BASE}/public/book/${workspaceSlug}/slots`,
    /** Hold a slot */
    HOLD_SLOT: (workspaceSlug) => `${API_BASE}/public/book/${workspaceSlug}/hold`,
    /** Complete booking */
    COMPLETE_BOOKING: (workspaceSlug) => `${API_BASE}/public/book/${workspaceSlug}/complete`,
